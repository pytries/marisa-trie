...
extern int __pyx_module_is_main_keyset;
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "keyset" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_keyset", 0);
