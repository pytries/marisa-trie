...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_KeyError = __Pyx_GetBuiltinName(__pyx_n_s_KeyError); if (!__pyx_builtin_KeyError) __PYX_ERR(0, 24, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
static int __pyx_pymod_exec_trie(PyObject *__pyx_pyinit_module)
#endif
#endif
{
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init trie", 0, __pyx_lineno, __pyx_filename);
    }
